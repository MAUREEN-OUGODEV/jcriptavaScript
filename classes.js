...
// function constructor for representing cars
//  in their inventory and another one for
// representing rental information.
// Requirements:
// 1) Create a Car class or function constructor
...
// toggleAvailability that changes the 
// isAvailable property to its opposite value (true to
// false, false to true)
...
car.toggleActivity()
console.log({car})  
// 2) Create a Rental class or function constructor that has
...
let carhire=new Rental("LandCruiser","Wambua",new Date('11/12/2020'),new Date('1/4/2023'))
console.log(carhire)
...
const question1 = new Question("What is the national language og kenya?", ["Kiswahili", "English", "French", "Luo"], "Kiswahili");
const question2 = new Question("Which month has 28 days?", ["January", "February", "March", "May"], "February");
quiz1.addQuestion(question1);
quiz1.addQuestion(question2);

quiz1.submitAnswer("Kiswahili");
quiz1.nextQuestion();
quiz1.submitAnswer("February");
